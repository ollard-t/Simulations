...
for(N in c(1000,3000,5000)){
  path0 <- paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/RésultatsPLANN/N",N,"_results/",PH_val,"/Output simulations_N",N,"_",PH_val,"_",cens_val,"/")
...
calc_indic <- function(N, iterations){
  ...
  save(list = ls(), file = paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/RésultatsPLANN/N",N,"_results/",PH_val,"/",length(iterations),"ite_",N,"ind_",PH_val,"_",cens_val,"_",date_launch,".Rdata"))
...
calc_indic_PP <- function(N, iterations){
  ...
  save(list = ls(), file = paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/RésultatsPLANN/N",N,"_results/",PH_val,"/",length(iterations),"ite_",N,"ind_",PH_val,"_",cens_val,"_",date_launch,"_PP.Rdata"))
...
mclapply(iterations, simulate_iteration, N = 1000, mc.cores = detectCores() - 5)
# 
# max_attempts <- 3
# attempt <- 1
# while (TRUE) {
...
#     break
#   }
#   mclapply(indic, simulate_iteration, N = 1000, mc.cores = detectCores() - 5)
#   attempt <- attempt + 1
# }
