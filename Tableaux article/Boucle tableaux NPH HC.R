...
latex_table <- function(N, strata, file_name){
  path1 <- paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/Résultats/N",N,"_results/NPH/",file_name,".Rdata")#nom à changer
  load(path1)
  
  ##pour aller récupérer les logliklihood
  
  path0 <- paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/N",N,"/Output simulations_N",N,"_NPH_HC/LOGLIK/")
  ...
  path3 <- paste0("~/Documents/Rstudio/Simulations/Simulations mai 2025/N",N,"/Output simulations_N",N,"_NPH_HC/")
