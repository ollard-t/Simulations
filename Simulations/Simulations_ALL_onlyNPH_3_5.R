...
mclapply(iterations, simulate_iteration, N = 3000, mc.cores = detectCores() - 5)
...
while (TRUE) {
  ...
  mclapply(indic, simulate_iteration, N = 3000, mc.cores = detectCores() - 5)
  attempt <- attempt + 1
}
...
mclapply(iterations, simulate_iteration, N = 5000, mc.cores = detectCores() - 5)
...
while (TRUE) {
  ...
  mclapply(indic, simulate_iteration, N = 5000, mc.cores = detectCores() - 5)
  attempt <- attempt + 1
}
